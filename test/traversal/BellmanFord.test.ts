...
describe("GRAPH SEARCH Tests - Bellman Ford - ", () => {
  ...
  describe("Bellman Ford Sanity Checks Tests - ", () => {
    test("should reject an undefined or null graph", () => {
      expect(BellmanFordDict.bind(BellmanFordDict, undefined)).toThrowError(
        "Graph as well as start node have to be valid objects."
      );
      expect(BellmanFordDict.bind(BellmanFordDict, null)).toThrowError(
        "Graph as well as start node have to be valid objects."
      );
    });
    ...
    test("should reject an undefined or null start node", () => {
      ...
      expect(BellmanFordDict.bind(BellmanFordDict, graph, undefined)).toThrowError(
        "Graph as well as start node have to be valid objects."
      );
      expect(BellmanFordDict.bind(BellmanFordDict, graph, null)).toThrowError(
        "Graph as well as start node have to be valid objects."
      );
    });
    ...
    test("should refuse to search a graph without edges", () => {
      ...
      expect(BellmanFordDict.bind(BellmanFordDict, graph, node)).toThrowError(
