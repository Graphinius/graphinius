...
describe("PFS TESTS - ", () => {
  ...
  describe("Basic Instantiation tests - ", () => {
    test("should refuse to traverse a graph without edges", () => {
      ...
      expect($PFS.PFS.bind($PFS.PFS, empty_graph, start)).toThrowError(
    ...
    test("should refuse to traverse a graph with DIR mode set to init", () => {
      ...
      expect($PFS.PFS.bind($PFS.PFS, graph, root, config)).toThrowError(
  ...
  describe("Config object instantiation tests - ", () => {
    test("should instantiate a default config object with correct result structure", () => {
      let config = $PFS.preparePFSStandardConfig();
      expect(config).toBeDefined();
      expect(config.result).toBeDefined();
    });

    test("should instantiate a default config object with correct DIR mode", () => {
      let config = $PFS.preparePFSStandardConfig();
      expect(config).toBeDefined();
    ...
    test("should instantiate a default config object with correctly structured callback object", () => {
      let config = $PFS.preparePFSStandardConfig();
      expect(config).toBeDefined();
      expect(config.callbacks).toBeDefined();
    ...
    test("should instantiate a default config object with correctly structured messages object", () => {
      let config = $PFS.preparePFSStandardConfig();
      expect(config).toBeDefined();
      expect(config.messages).toBeDefined();
    ...
    test("should instantiate a default config object with goal node set to null", () => {
      let config = $PFS.preparePFSStandardConfig();
      expect(config).toBeDefined();
      expect(config.goal_node).toBeNull();
    });

    test("should instantiate a default config object with an existing init_pfs callback", () => {
      let config = $PFS.preparePFSStandardConfig();
      expect(config.callbacks).toBeDefined();
      expect(config.callbacks.init_pfs).toBeDefined();
