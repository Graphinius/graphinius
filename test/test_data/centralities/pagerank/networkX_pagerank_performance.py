...
file = open('./pagerank_social_network_edges_300_results.json', 'w')
...
file = open('./pagerank_social_network_edges_1K_results.json', 'w')
...
file = open('./pagerank_social_network_edges_20K_results.json', 'w')
...
file = open('./pagerank_social_network_edges_300_weighted_results.json', 'w')
...
file = open('./pagerank_social_network_edges_1K_weighted_results.json', 'w')
...
file = open('./pagerank_social_network_edges_20K_weighted_results.json', 'w')
