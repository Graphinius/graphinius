import { EdgeDupeChecker, PotentialEdgeInfo } from "@/io/common/Dupes";
import { IBaseEdge, BaseEdge } from "@/core/base/BaseEdge";
...
describe("Edge DUPE tests", function () {
  ...
  const nodeTypeA = "PERSON",
    nodeTypeB = "COFFEE",
    nodeTypeC = "PERSON",
    nodeTypeD = "OFFICE";

  let edc: EdgeDupeChecker,
    a: ITypedNode,
    b: ITypedNode,
    c: ITypedNode,
    d: ITypedNode,
