...
describe("GRAPH JSON OUTPUT TESTS - ", () => {
  describe("Output toy JSON structs", () => {
    ...
    test("Should correctly output a graph of two nodes and an UNdirected edge", () => {
      let n_a = graph.addNodeByID("A");
    ...
    test("Should correctly output a graph of two nodes and a directed edge", () => {
      let n_a = graph.addNodeByID("A");
      let n_b = graph.addNodeByID("B");
    ...
    test("Should correctly output a graph of two nodes and a directed edge with weight", () => {
      let n_a = graph.addNodeByID("A");
      let n_b = graph.addNodeByID("B");
      graph.addEdgeByID("Single directed edge", n_b, n_a, {
        directed: true,
  ...
  describe("Writing small JSON structs from file", () => {
    ...
    test("Should correctly output search graph file after reading from file", () => {
      jsonIn = new JSONInput(std_json_in_config);
      graph = jsonIn.readFromJSONFile(search_graph_in);
