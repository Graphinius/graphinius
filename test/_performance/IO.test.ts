...
import { CSVInput } from "@/io/input/CSVInput";
...
const graph_6K_file = `${JSON_DATA_PATH}/real_graph.json`,
...
describe("CSVInput performance tests - ", () => {
  test("should construct a real sized graph from an edge list, UNdirected", () => {
  ...
  test("should construct a real sized graph from an edge list with edges, directed", () => {
