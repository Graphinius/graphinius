...
import { Similarity } from "@/similarities/interfaces";
import { sim, simSource, simPairwise, sortFuncs, knnNodeArray, viaSharedPrefs } from "@/similarities/SimilarityCommons";
import { setSimFuncs as simFuncs } from "@/similarities/SetSimilarities";
...
describe("JACCARD tests on neo4j sample graph", () => {
  const gFile = JSON_SIM_PATH + "/cuisine.json",
