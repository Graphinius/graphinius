...
import { sim, simSource, simPairwise, simSubsets, knnNodeArray, getBsNotInA } from "@/similarities/SimilarityCommons";
...
describe("COSINE tests on neo4j sample graph", () => {
  const gFile = JSON_SIM_PATH + "/cuisineCosine.json",
