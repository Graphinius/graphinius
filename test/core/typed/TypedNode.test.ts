import { ITypedNode, TypedNode, TypedNodeConfig } from "@/core/typed/TypedNode";
...
describe("==== NODE TESTS ====", () => {
  ...
  describe("Unique Neighbor ID builder tests - ", () => {
    let graph: TypedGraph, a: ITypedNode, b: ITypedNode, e: ITypedEdge;
    ...
    it("should return `A#42#w#1", () => {
      ...
      expect(b.uniqueNID(e)).toBe("A#42#w#1");
    });
  });
  ...
  describe("Edge addition / deletion tests - ", () => {
    ...
    let graph: TypedGraph, a, b, c: ITypedNode, e1, e2, e3: ITypedEdge;
