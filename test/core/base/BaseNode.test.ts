...
import { BaseNode, IBaseNode, NeighborEntry } from "@/core/base/BaseNode";
...
describe("==== NODE TESTS ====", () => {
  ...
  describe("Node edge addition / query / removal tests - ", () => {
    ...
    describe("Node edge addition tests", () => {
      ...
      test("should throw an error if we try to add an unidrected edge more than once", () => {
    ...
    describe("Node single edge queries", () => {
      ...
      test("should throw an error upon trying to retrieve a non-existing edge", () => {
        node_a.clearEdges();
    ...
    describe("a little more complex scenario - ", () => {
      ...
      describe("previous, next, connected and adjacent nodes", () => {
        ...
        test("should find nodes a, b, c and d as adjacent (reachable) nodes", () => {
          let adjs = collectNodesFromNeighbors(
            n_a.reachNodes(ne => {
      ...
      describe("deletion of single edges by type", () => {
        let n_a, n_b, n_c, n_d, e_1, e_2, e_3, e_4, e_5, e_6, e_7, e_8;
        ...
        test("should correctly delete an undirected loop edge by reference", () => {
          n_a.removeEdge(e_8);
          let unds = n_a.undEdges();
          expect(Object.keys(unds).length).toBe(2);
          expect(unds[1]).toBe(e_1);
    ...
    describe("Node edge clearing", () => {
      let node_a, edge_1, edge_2, edge_3;
      ...
      test("should clear all outgoing edges and update degrees accordingly", () => {
      ...
      test("should clear all undirected edges and update degrees accordingly", () => {
