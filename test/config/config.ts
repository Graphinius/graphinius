 ...
 * Result files paths
 */
export const RES_CENT_PATH = `./data/results/centralities`;

/**
 * CSV files paths
 */
export const CSV_DATA_PATH = `./data/csv/general`;
export const CSV_CENT_PATH = `./data/csv/centralities`;
 ...
 * JSON files paths
 */
export const JSON_DATA_PATH = `./data/json/general`;
