...
import * as $EME from "@/energyminimization/ExpansionBoykov";
...
describe("EME Boykov Tests - ", () => {
  ...
  describe("Helper Functions Tests - ", () => {
    ...
    test("should correctly construct the expansion graph", () => {
      ...
      let aux_nodes_ind = Object.keys(nodes).filter(
        element => pixel_nodes.concat(["SOURCE", "SINK"]).indexOf(element) < 0
      );
