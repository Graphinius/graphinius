...
var ComputeGraph = (function () {
    ...
    ComputeGraph.prototype.adjListArray = function (incoming, include_self, self_dist) {
        if (incoming === void 0) { incoming = false; }
        ...
        var adjDict = this.adjListDict(incoming, include_self, self_dist);
        for (var i = 0; i < this._g.nrNodes(); ++i) {
            adjList.push([]);
            for (var j = 0; j < this._g.nrNodes(); ++j) {
    ...
    ComputeGraph.prototype.adjListDict = function (incoming, include_self, self_dist) {
        if (incoming === void 0) { incoming = false; }
        if (include_self === void 0) { include_self = false; }
        if (self_dist === void 0) { self_dist = 0; }
    ...
    Object.defineProperty(ComputeGraph.prototype, "clustCoef", {
        get: function () {
            ...
            var adj_list = this.adjListArray();
