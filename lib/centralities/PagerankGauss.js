...
var Gauss_1 = require("../utils/Gauss");
var PagerankGauss = (function () {
    function PagerankGauss() {
    }
    PagerankGauss.prototype.getCentralityMap = function (graph, weighted) {
        var divideTable = {};
        var matr = [];
        var ctr = 0;
        var map = {};
    ...
    return PagerankGauss;
}());
exports.PagerankGauss = PagerankGauss;
