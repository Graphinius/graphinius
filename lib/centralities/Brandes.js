    ...
    Brandes.prototype.computeUnweighted = function (normalize, directed) {
        ...
        for (var i in nodes) {
            ...
            while (S.length >= 1) {
                w = S.pop();
                try {
                    for (var _b = (e_1 = void 0, __values(Pred[w])), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    Brandes.prototype.computeWeighted = function (normalize, directed) {
        ...
        for (var i in nodes) {
            ...
            while (S.length >= 1) {
                w = S.pop();
                try {
                    for (var _b = (e_2 = void 0, __values(Pred[w])), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    Brandes.prototype.computePFSbased = function (normalize, directed) {
        ...
        for (var i in nodes) {
            ...
            while (S.length >= 1) {
                var w = S.pop();
                try {
                    for (var _b = (e_3 = void 0, __values(Pred[w])), _c = _b.next(); !_c.done; _c = _b.next()) {
