...
function knnNodeDict(algo, s, cfg) {
    ...
    var _loop_1 = function (node) {
        ...
        try {
            for (var _b = (e_4 = void 0, __values(Object.values(topK))), _c = _b.next(); !_c.done; _c = _b.next()) {
                var arr = _c.value;
                arr.sort(sort);
            }
        }
...
function viaSharedPrefs(g, algo, cfg) {
    ...
    try {
        for (var _c = __values(t1Set.entries()), _d = _c.next(); !_d.done; _d = _c.next()) {
            ...
            try {
                for (var _f = (e_6 = void 0, __values(t2Set.entries())), _g = _f.next(); !_g.done; _g = _f.next()) {
