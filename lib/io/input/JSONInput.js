...
var JSONInput = (function () {
    ...
    JSONInput.prototype.readFromJSON = function (json, graph) {
        ...
        for (var node_id in json.data) {
            ...
            for (var e in edges) {
                ...
                var edge_type = edge_input[interfaces_1.labelKeys.e_type];
    ...
    JSONInput.prototype.addNodesToGraph = function (json, graph) {
        ...
        for (var node_id in json.data) {
            var type = BaseGraph_1.BaseGraph.isTyped(graph) ? json.data[node_id][interfaces_1.labelKeys.n_type] : null;
