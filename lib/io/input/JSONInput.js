...
class JSONInput {
    ...
    static handleEdgeWeights(edge_input) {
        switch (edge_input[interfaces_1.abbs.e_weight]) {
            case "undefined":
            ...
            default:
                return parseFloat(edge_input[interfaces_1.abbs.e_weight]);
        }
    }
}
